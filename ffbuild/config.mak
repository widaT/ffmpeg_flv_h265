...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-libopus --enable-encoder=libopus --enable-libx264 --enable-gpl --enable-libvpx --enable-libvorbis --enable-libsrt --extra-ldflags=-lstdc++ --extra-libs='-lpthread -lm -lssl -lcrypto' --enable-sdl2 --enable-libx265
prefix=/usr/local
...
CC_IDENT=gcc 8 (Uos 8.3.0.3-3+rebuild)
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=
CC=gcc
...
CFLAGS=   -std=c11 -fomit-frame-pointer    -pthread  -I/usr/local/include/opus -I/usr/local/include/opus -I/usr/local/include -I/usr/local/include/srt   -I/usr/local/include -I/usr/local/include -I/usr/local/include -I/usr/local/include -I/usr/local/include -DX264_API_IMPORTS -I/usr/local/include      -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized -I/usr/local/include/SDL2 -D_REENTRANT
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -lstdc++  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS=-lpthread -lm -lssl -lcrypto 
COMPAT_OBJS=
INSTALL=install
LIBTARGET=
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-lm -latomic -lxcb -lxcb-shm -lxcb-shape -lxcb-xfixes -lasound -L/usr/local/lib -Wl,-rpath,/usr/local/lib -Wl,--enable-new-dtags -pthread -lSDL2 -lXv -lX11 -lXext
EXTRALIBS-avfilter=-pthread -lm -latomic
EXTRALIBS-swscale=-lm -latomic
EXTRALIBS-postproc=-lm -latomic
EXTRALIBS-avformat=-lm -latomic -lbz2 -lz -L/usr/local/lib -lsrt
EXTRALIBS-avcodec=-L/usr/local/lib -lvpx -lm -L/usr/local/lib -lvpx -lm -L/usr/local/lib -lvpx -lm -L/usr/local/lib -lvpx -lm -pthread -lm -latomic -llzma -L/usr/local/lib -lopus -lvorbis -lvorbisenc -L/usr/local/lib -lx264 -L/usr/local/lib -lx265 -lz
EXTRALIBS-swresample=-lm -latomic
EXTRALIBS-avutil=-pthread -lm -latomic -lX11
EXTRALIBS-ffplay=-L/usr/local/lib -Wl,-rpath,/usr/local/lib -Wl,--enable-new-dtags -pthread -lSDL2
EXTRALIBS-ffprobe=
EXTRALIBS-ffmpeg=
