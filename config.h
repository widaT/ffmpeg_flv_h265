...
#define FFMPEG_CONFIGURATION "--enable-libopus --enable-encoder=libopus --enable-libx264 --enable-gpl --enable-libvpx --enable-libvorbis --enable-libsrt --extra-ldflags=-lstdc++ --extra-libs='-lpthread -lm -lssl -lcrypto' --enable-sdl2 --enable-libx265"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2022
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "gcc 8 (Uos 8.3.0.3-3+rebuild)"
